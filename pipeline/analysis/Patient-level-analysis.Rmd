...
params:
  cells: "raw_data/schapiro/schapiro_subset_sce.rds"
  celltypes: "raw_data/schapiro/schapiro_subset_assignments_type.csv"
  cellstates: "raw_data/schapiro/schapiro_subset_assignments_state.csv" 
  metadata: "raw_data/schapiro/schapiro_PatientMetadata.csv"
  cohort: "schapiro"
---
...
Heatmap(t(as.matrix(freqPerCoreClean %>% 
                      select(-PID))),
      column_dend_height = unit(5, "cm"),
...
```{r fig.height=8, eval= evalStatement}
...
```{r eval = evalStatement, fig.height=9}
