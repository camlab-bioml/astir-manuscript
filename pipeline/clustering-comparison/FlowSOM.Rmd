...
FlowSOM.k8.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$FlowSOM.k8))))
...
FlowSOM.k12.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    which="column",
                    col = list(`Cell type` = jackson_basel_colours()),
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$FlowSOM.k12))))
...
FlowSOM.k15.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    which="column",
                    col = list(`Cell type` = jackson_basel_colours()),
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$FlowSOM.k15))))
...
FlowSOM.k20.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    which="column",
                    col = list(`Cell type` = jackson_basel_colours()),
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$FlowSOM.k20))))
