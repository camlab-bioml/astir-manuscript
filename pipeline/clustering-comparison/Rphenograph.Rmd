...
phenograph.k20.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$phenograph.k20))))
...
phenograph.k30.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    which="column",
                    col = list(`Cell type` = jackson_basel_colours()),
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$phenograph.k30))))
...
phenograph.k40.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    which="column",
                    col = list(`Cell type` = jackson_basel_colours()),
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$phenograph.k40))))
...
phenograph.k50.ha <- 
  HeatmapAnnotation(`Cell type` = sce$cell_type,
                    ...
                    which="column",
                    col = list(`Cell type` = jackson_basel_colours()),
                    `phenograph cluster` = distinctColorPalette(length(unique(sce$phenograph.k50))))
