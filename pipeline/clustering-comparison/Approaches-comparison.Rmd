...
#df_gsva <- read_csv("../output/v4/results/GSVA-enrichments-basel.csv")
```
...
write.csv(methods.summary, 
          file = paste0("../output/v4/results/Assessment-individual-heatmap-",
                                   params$cohort, ".csv"),
...
write.csv(clPerType, file = paste0("../output/v4/results/Assessment-heatmap-",
                                   params$cohort, ".csv"),
