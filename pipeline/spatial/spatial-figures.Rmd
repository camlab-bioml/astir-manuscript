...
params:
  basel_output: ../../output/chipmunk/spatial/rds_output_basel.rds
  zurich1_output: ../../output/chipmunk/spatial/rds_output_zurich1.rds
  basel_expression: ../../output/chipmunk/spatial/summarized-expression-basel.tsv
  zurich1_expression: ../../output/chipmunk/spatial/summarized-expression-zurich1.tsv
  ...
  cells_counted_basel: cells_counted_basel.tsv
  kaplan_meier: km.pdf
  pathway_fig: pw.pdf
...
```{r}
pdf(params$spatial_heatmap, width = 8, height = 6)
draw(ht, heatmap_legend_side = "bottom", annotation_legend_side = "bottom",
...
# load("../../output/chipmunk/figures/spatial/km.pdf-img.rds")
```
